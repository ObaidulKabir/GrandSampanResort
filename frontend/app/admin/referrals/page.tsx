  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-ocean/70">
            Track broker/client incentives. Mark unlocked tranches as paid when payouts are sent.
          </p>
        </div>
      ...
      <section className="mt-8 border border-ocean/10 bg-white p-5">
        <h2 className="font-display text-xl text-ocean">Policy</h2>
        <p className="mt-1 text-sm text-ocean/65">
          Current: {policy?.incentivePct ?? 2}% of sale · {policy?.tranche1Pct ?? 40}% on confirm ·{' '}
